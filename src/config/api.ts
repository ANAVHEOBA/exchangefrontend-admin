...
export const API_CONFIG = {
  ...
  endpoints: {
    ...
    adminAssets: '/ops/assets',
    adminAssetSync: '/ops/assets/sync',
    adminAssetValidate: '/ops/assets/validate-address',
    adminCatalog: '/ops/catalog/giftcards',
    adminProviders: '/ops/providers',
    adminProviderSync: '/ops/providers/sync',
    adminSettings: '/ops/settings',
    adminSettingsDiagnostics: '/ops/settings/diagnostics',
    adminSwaps: '/swap/ops',
